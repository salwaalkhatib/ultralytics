...
class Prototypes():
    def __init__(self, num_classes, contr_feats, queue_size=10, contr_calib=False):
        ...
        self.calibrator = PrototypeRecalibrator(cls_num_list=[79124, 13007, 1122, 6445, 1487, 1175, 4455, 80708, 474600, 1437, 4907, 955, 1574, 18437, 14995], num_classes=num_classes)
        # Validation stats
...
class PrototypeRecalibrator():
    def __init__(self, cls_num_list, beta=0.95, initial_wc=0.01, num_classes=15):
        ...
        self.wc = torch.tensor([[initial_wc for _ in range(num_classes)] for _ in range(3)])
        self.num_classes = num_classes
