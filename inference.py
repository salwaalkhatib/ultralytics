...
model.train(data="isaid.yaml", epochs=EPOCHS, batch=8, save_period=9, workers=24, resume='runs/detect/isaid_contrastive0.9epochs_502/weights/last.pt', name=EXPERIMENT, contr_loss=CONTRASTIVE_LOSS)
